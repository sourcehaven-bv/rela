...
type AnalyzeCmd struct {
	...
	States        AnalyzeStatesCmd        `cmd:"" help:"Find content-state integrity issues (undeclared pointers, headless families)."`
...
// (TKT-DOFYR1): rows stored under pointers no metamodel declaration
