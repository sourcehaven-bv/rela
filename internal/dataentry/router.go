...
func (a *App) NewRouter() http.Handler {
	...
	inner.HandleFunc("/assets", a.handleAssets)
	inner.HandleFunc("/attachments/", a.handleAttachmentServe)
	inner.HandleFunc("/api/upload", a.handleFileUpload)
	inner.HandleFunc("/api/asset/list", a.handleAssetList)
	inner.HandleFunc("/api/asset/preview", a.handleAssetPreview)
	inner.HandleFunc("/api/asset/rename", a.handleAssetRename)
	inner.HandleFunc("/api/asset/delete", a.handleAssetDelete)
	inner.HandleFunc("/api/asset/gc", a.handleAssetGC)
