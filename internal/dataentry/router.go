...
func (a *App) NewRouter() http.Handler {
	...
	inner.HandleFunc("/api/relation-candidates", a.handleRelationCandidates)
	inner.HandleFunc("/api/relation-edit-form", a.handleRelationEditForm)
	inner.HandleFunc("/api/relation-card-update", a.handleRelationCardUpdate)
	inner.HandleFunc("/api/relation-props-display", a.handleRelationPropsDisplay)
