...
-- 42P21, and the face now participates in that walk.

-- entity_versions: the face joins the lineage key.
ALTER TABLE entity_versions ADD COLUMN face TEXT COLLATE "C" NOT NULL DEFAULT '';
ALTER TABLE entity_versions DROP CONSTRAINT entity_versions_pkey;
ALTER TABLE entity_versions ADD PRIMARY KEY (entity_id, face, vseq);
...
ALTER TABLE relation_versions ADD COLUMN from_face TEXT COLLATE "C" NOT NULL DEFAULT '';
