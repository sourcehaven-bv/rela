...
The plan counted four pgstore `pointer = ''` sites (F1) and one ACL `AllowAll`
...
e.pointer = ''` with a TKT-DOFYR1 comment that reads as already-handled.
