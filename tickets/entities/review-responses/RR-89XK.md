...
resolution: writeGateError maps context.Canceled → emit nothing; context.DeadlineExceeded → 504 acl_query_timeout; else 500 acl_query_failed. Centralized so every gate call site uses the same shape. TestACLGet_WriteGateErrorMapping pins the three branches.
status: addressed
---
