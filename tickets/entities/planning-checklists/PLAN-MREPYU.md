...
title: 'Planning: Stop passing user-controlled IDs on the command line (use temp file)'
status: done
---
...
- [x] ~~For larger features: run `/research` to create a structured research doc~~ (N/A: approach fixed by the ticket)
...
- [x] ~~Run `/design-review` before starting implementation~~ (N/A: the {id}-removal decision was taken with the user directly)
