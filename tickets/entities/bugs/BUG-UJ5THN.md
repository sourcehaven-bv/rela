...
priority: high
effort: xs
why1: The test asserted face identity between the policy-less script reader and app.store (any(reader) != any(app.store)), which no longer holds.
